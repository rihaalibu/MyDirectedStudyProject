    ...
    public partial class loginMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicalResources", x => x.EmployeeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMaintenanceProject = table.Column<bool>(type: "boolean", nullable: false),
                    ProjectValue = table.Column<decimal>(type: "numeric", nullable: false),
                    ClientId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectResourceAllocations", x => x.AllocationId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectResourceAllocations_TechnicalResources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "TechnicalResources",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectResourceAllocations_ResourceId",
                table: "ProjectResourceAllocations",
                column: "ResourceId");
